...
p_hulist = [0, 0.0005758307526916227, 0.0014530524152272174, 0.00283857222930843, 0.004509446357468525, 0.006453521068088563, 0.008441226349984733, 0.010344217169258547, 0.01201639425997773, 0.013334817323696126, 0.014353321837561257, 0.014909372537297209, 0.014963704037636832, 0.014729279295340509, 0.014228322075750251, 0.01374354434728641, 0.012776600968973782, 0.011447129778681358, 0.009505992750091879, 0.007588647827162613, 0.005754667694192915, 0.003988867944975741, 0.0025808000751040804, 0.0014798971140866138, 0.0007560534742675732, 0.0003037068805253945, 0.00010919102809111969, 2.3046147605966186e-05, 5.531585352361987e-06, 0.0, 4.6097564573468453e-07, 0.0, 0.0, 0.0, 0.0]
# p_hulist = [0, 0.002303323010766491, 0.00581220966090887, 0.01135428891723372, 0.0180377854298741, 0.02581408427235425, 0.033764905399938934, 0.04137686867703419, 0.04806557703991092, 0.053339269294784504, 0.05741328735024503, 0.059637490149188836, 0.05985481615054733, 0.058917117181362035, 0.056913288303001006, 0.05497417738914564, 0.05110640387589513, 0.04578851911472543, 0.038023971000367515, 0.030354591308650453, 0.02301867077677166, 0.015955471779902964, 0.010323200300416321, 0.005919588456346455, 0.0030242138970702926, 0.001214827522101578, 0.00043676411236447875, 9.218459042386474e-05, 2.2126341409447948e-05, 0.0, 1.8439025829387381e-06, 0.0, 0.0, 0.0, 0.0]
...
if __name__ == '__main__':
    ...
    recorder = [[0], [0, [7, 9, 9, 10, 10, 13, 19, 20, 22, 22, 24, 26, 33], []],[3, 1, None], [3, 2, 31], [0, 1, 2], [0, 2, 7], [1, 41, 7], [1, 2, 32], [2, 1, None], [2, 2, 29], [1, 5, 29],
      [1, 2, 27], [2, 1, None], [2, 2, 8], [3, 1, None], [3, 2, 29], [0, 1, 17], [0, 2, 17], [1, 1, None], [1, 2, 16],
      [2, 1, None], [2, 2, 4], [3, 1, None], [3, 2, 33], [0, 1, 19], [0, 2, 33], [1, 1, None], [1, 2, 26], [3, 5, 26],
      [3, 2, 5], [0, 1, 22], [0, 2, 26], [1, 1, None], [1, 2, 9], [0, 5, 9], [0, 2, 24], [1, 1, None], [1, 2, 11],
      [3, 5, 11], [3, 2, 17], [0, 1, 8], [0, 2, 8], [1, 1, None], [1, 2, 12], [2, 1, None], [2, 2, 6], [3, 1, None],
      [3, 2, 3], [0, 1, 19], [0, 2, 20], [1, 1, None], [1, 2, 24], [2, 1, None], [2, 2, 12], [3, 1, None], [3, 2, 19],
      [0, 1, 20], [0, 2, 20], [1, 1, None], [1, 2, 4], [2, 1, None], [2, 2, 31], [3, 1, None], [3, 2, 23], [0, 1, 28],
      [0, 2, 28], [1, 1, None], [1, 2, 0], [2, 1, None], [2, 2, 31]]

    zhuangtaikongzhi = 0
    zhuangtainum = np.zeros((30, 36))
    # print(len(recorder),'这是长度')
    # print(zhuangtainum)
    # for i in range(3,len(recorder)):
    for i in range(3, len(recorder)):
        # print('dbaisdbaisbdiasndkasndkjabsdkjasbdkjabskjdbaskjdbnaskjdnas')
